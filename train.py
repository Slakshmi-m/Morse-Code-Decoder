...
Run generate_dataset.py first, then: python train.py
...
class MorseDataset(Dataset):
    def __init__(self, meta_path: str, n_mels: int = 64, sr: int = 8000):
...
def train(
    ...
    full = MorseDataset(os.path.join(dataset_dir, 'metadata.json'))
